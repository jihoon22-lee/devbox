...
export type ToolsMode = "local-quality" | "doctor" | "dev-setup" | "related-tools";
export default function App({mode}:{mode?:ToolsMode}={}) {
  ...
  const [tab, setTab] = useState<"apps" | ToolsMode>(mode??"apps");
  ...
  const embeddedLoadRef = useRef({
    ...
    "local-quality": onInspectLocalQuality,
  });
