...
export type KnowledgeOpenAction =
  ...
  | { kind: "draft"; id: string; handoffKind: "knowledge-draft/v1" | "knowledge-draft/v2" | "knowledge-session/v1" | "knowledge-result/v1" }
  ...
  switch (target.kind) {
    ...
    case "handoff":
      return (target.handoffKind === "knowledge-draft/v1"
          ...
          || target.handoffKind === "knowledge-session/v1"
          || target.handoffKind === "knowledge-result/v1")
