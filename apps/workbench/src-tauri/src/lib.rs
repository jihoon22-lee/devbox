...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::templates::list_profile_templates,
            commands::templates::create_profile_template,
            commands::templates::update_profile_template,
            commands::templates::delete_profile_template,
            commands::templates::create_profile_from_template,
