...
export default function TabBar({ tabs, activeTabId, onActivate, onClose, onReorder, onDropPane, onNewTab }: TabBarProps) {
  ...
  return (
    <div className="tab-bar">
      ...
      <button className="tab-add" title="New tab (Ctrl+Shift+T)" onClick={onNewTab}>
        +
      </button>
    </div>
  );
