...
product_ipc::issue_codes! {pub enum DeliveryIssue {BootstrapArgumentsInvalid="bootstrap_arguments_invalid",BootstrapClockInvalid="bootstrap_clock_invalid",BootstrapDataUnavailable="bootstrap_data_unavailable",BootstrapDataUnsafe="bootstrap_data_unsafe",BootstrapDispatcherUntrusted="bootstrap_dispatcher_untrusted",BootstrapGateChanged="bootstrap_gate_changed",BootstrapGateUnavailable="bootstrap_gate_unavailable",BootstrapGateUnsafe="bootstrap_gate_unsafe",BootstrapHelperBusy="bootstrap_helper_busy",BootstrapIdentityUnavailable="bootstrap_identity_unavailable",BootstrapJournalMissing="bootstrap_journal_missing",BootstrapLaunchFailed="bootstrap_launch_failed",BootstrapOwnerChanged="bootstrap_owner_changed",BootstrapOwnerInvalid="bootstrap_owner_invalid",BootstrapPayloadChanged="bootstrap_payload_changed",BootstrapPayloadIncomplete="bootstrap_payload_incomplete",BootstrapRestoreRetentionReviewRequired="bootstrap_restore_retention_review_required",BootstrapRootChanged="bootstrap_root_changed",BootstrapRootUnsafe="bootstrap_root_unsafe",BootstrapStorePreparationRequired="bootstrap_store_preparation_required",BootstrapUpdatePending="bootstrap_update_pending",CheckpointMissing="checkpoint_missing",DowngradeRequiresBackupExport="downgrade_requires_backup_export",InstallationFolderUnavailable="installation_folder_unavailable",InventoryUnavailable="inventory_unavailable",InventoryWorkerUnavailable="inventory_worker_unavailable",ManagerToolsUnavailable="manager_tools_unavailable",RestoreActionAlreadyStarted="restore_action_already_started",RestoreActionInvalid="restore_action_invalid",RestoreOperationConflict="restore_operation_conflict",RestoreOperationInvalid="restore_operation_invalid",RestoreOperationUnsafe="restore_operation_unsafe",RestorePlanChanged="restore_plan_changed",RestorePlanInvalid="restore_plan_invalid",RestoreRecordInvalid="restore_record_invalid",RestoreRecordUnavailable="restore_record_unavailable",RestoreWorkerUnavailable="restore_worker_unavailable",SuiteHealthInvalid="suite_health_invalid",SuiteHealthRequired="suite_health_required",SuiteJournalChanged="suite_journal_changed",SuiteJournalMissing="suite_journal_missing",SuiteJournalStale="suite_journal_stale",SuiteOwnerChanged="suite_owner_changed",SuiteOwnerExpired="suite_owner_expired",SuiteOwnerInvalid="suite_owner_invalid",SuiteOwnerPhaseInvalid="suite_owner_phase_invalid",SuiteSpaceInsufficient="suite_space_insufficient",SuiteStoreUnavailable="suite_store_unavailable",SuiteWindowsRequired="suite_windows_required",SuiteWritersMustClose="suite_writers_must_close",Unavailable="unavailable",UpdateActivationInvalid="update_activation_invalid",UpdateAlreadyInstalled="update_already_installed",UpdateAlreadyLaunched="update_already_launched",UpdateAssetChanged="update_asset_changed",UpdateAssetMissing="update_asset_missing",UpdateAssetTopologyInvalid="update_asset_topology_invalid",UpdateBusy="update_busy",UpdateCacheChanged="update_cache_changed",UpdateCacheConflict="update_cache_conflict",UpdateCacheUnavailable="update_cache_unavailable",UpdateCacheUnsafe="update_cache_unsafe",UpdateCallerUntrusted="update_caller_untrusted",UpdateClaimChanged="update_claim_changed",UpdateClaimInvalid="update_claim_invalid",UpdateClockInvalid="update_clock_invalid",UpdateCommitStarted="update_commit_started",UpdateCommittedInstallationRequired="update_committed_installation_required",UpdateDownloadCancelled="update_download_cancelled",UpdateDownloadFailed="update_download_failed",UpdateDownloadLarge="update_download_large",UpdateDownloadRequired="update_download_required",UpdateInstalledSuiteRequired="update_installed_suite_required",UpdateJournalChanged="update_journal_changed",UpdateLaunchFailed="update_launch_failed",UpdateManifestChanged="update_manifest_changed",UpdateManifestDigestMissing="update_manifest_digest_missing",UpdateManifestMissing="update_manifest_missing",UpdateNetworkTimeout="update_network_timeout",UpdateNetworkUnavailable="update_network_unavailable",UpdateOperationConflict="update_operation_conflict",UpdateOperationInvalid="update_operation_invalid",UpdateOtherGenerationPending="update_other_generation_pending",UpdateOtherRecoveryPending="update_other_recovery_pending",UpdateOwnerChanged="update_owner_changed",UpdateOwnerInvalid="update_owner_invalid",UpdatePlanChanged="update_plan_changed",UpdatePlanInvalid="update_plan_invalid",UpdatePreviousOperationIncomplete="update_previous_operation_incomplete",UpdateProgressInvalid="update_progress_invalid",UpdateRecordInvalid="update_record_invalid",UpdateRecordWriteFailed="update_record_write_failed",UpdateRecordsChanged="update_records_changed",UpdateReleaseInvalid="update_release_invalid",UpdateRequestInvalid="update_request_invalid",UpdateResumeSelectedAction="update_resume_selected_action",UpdateRetentionReviewRequired="update_retention_review_required",UpdateReviewExpired="update_review_expired",UpdateReviewInvalid="update_review_invalid",UpdateRevisionExhausted="update_revision_exhausted",UpdateRootChanged="update_root_changed",UpdateStoreUnavailable="update_store_unavailable",UpdateVersionInvalid="update_version_invalid",}}
