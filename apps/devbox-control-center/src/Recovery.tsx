...
interface Status {state:"none"|"recorded";phase?:string;committed?:boolean;recovery?:string;backupCount?:number;dataCheckpointCount?:number;importCount?:number;recordedOwnerCount?:number;cleanupPending?:number;failure?:string|null}
