...
function Content({ route, navigate }: ShellContentProps) {
  ...
  return <>
    {group === "notes" && showSettings && <div className="knowledge-settings-page"><button type="button" onClick={() => setShowSettings(null)}>노트로 돌아가기</button><RecoveryBoundary name="기능"><Suspense fallback={<p role="status">설정을 불러오고 있습니다…</p>}><VaultSettings/></Suspense></RecoveryBoundary></div>}
