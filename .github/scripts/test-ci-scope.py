...
assert secrets.rust_packages == sorted(["devbox-logs-engine", "devbox-ports-engine", "devbox-terminal-engine", "devbox-activity-engine", "devbox-content-index-engine", "devbox-toolbox-engine", "devbox-webhook-host", "product-ipc", "devbox-installation-tools", "devbox-http-client-engine", "devbox-api-studio", "devbox-control-center", "devbox-knowledge", "devbox-workspace", "devbox-knowledge-vault-engine", "product-contract", "product-shell-tauri", "devbox-runtime-engine", "secrets", "devbox-projects-engine", "workspace-wsl", "suite-runtime"])
