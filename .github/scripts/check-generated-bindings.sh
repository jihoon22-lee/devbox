...
if [[ $mode == generate ]]; then
  cargo test --locked -p devbox-knowledge -p devbox-api-studio -p devbox-control-center --test typescript
fi
...
directories=(packages/knowledge-features/src/generated packages/api-studio-features/src/generated packages/control-center-features/src/generated)
