# Shared definitions only. Callers enforce disposable-host and ownership guards
# before invoking installer mutations. No installer runs when this is dot-sourced.
