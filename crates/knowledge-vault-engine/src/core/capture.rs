...
"##
    ...
    #[test]
    fn immediate_capture_cannot_select_a_target_path() {
        let direct_input = serde_json::json!({
            "title": "title", "body": "body", "tags": [], "path": "../../outside.md"
        });
        assert!(serde_json::from_value::<QuickCaptureInput>(direct_input).is_err());
    }
